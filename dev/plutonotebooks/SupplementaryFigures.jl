...
# ╔═╡ ff56fe08-9f0f-4311-9f2a-e0a04551f851
md"A table of contents is available by clicking on the menu link on the right."

# ╔═╡ da2a7262-8f13-414d-99fd-28bfb9118a5f
md"All figures in this notebook were generated from simulation analysis with the [ComplexMixtures.jl](https://m3g.github.io/ComplexMixtures.jl) package, and using [Plots.jl](https://docs.juliaplots.org/stable/)."
...
plot(
	Images.load("Figures/SI_mddfs_cl_dca.png"), 
	size=(800, 600), framestyle=:none, ticks=false
)
...
plot(
	Images.load("Figures/SI_mddfs_bf4_no3.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/SI_mddfs_cl_dca-cat.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/SI_mddfs_bf4_no3-cat.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/density2D_diff_DCA.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/density2D_diff_Cl.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/density2D_diff_BF4.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/density2D_diff_NO3.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/pref_hydration.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/CN_anion_water.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/DCA_BF4_ion-ion_ion-water.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/NO3_Cl_ion-ion_ion-water.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/SI_water/SI_mddfs_bf4_no3-water.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/SI_water/SI_kbis_bf4_no3-water.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/SI_water/SI_mddfs_cl_dca-water.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
plot(
	Images.load("Figures/SI_water/SI_kbis_cl_dca-water.png"),
	size=(800, 600), ticks=false, framestyle=:none
)
...
manifest_format = "2.0"
project_hash = "fa10493963e3c271f2cecccdc7b6443ade770132"
