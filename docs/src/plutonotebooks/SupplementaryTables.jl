...
md"**Table S1** – Reference concentrations (**RC**), in $\text{mol L}^{-1}$, are the target initial concentrations for the system setup. **Box sides** represent the dimensions of the cubic box after equilibration, where all boxes initially had a starting length of 95 Å. Number of cations (**Cation**), anions (**Anion**), and water molecules (**Water**) in each system are shown."
...
md"**Table S2** – Average bulk concentrations ($\text{mol L}^{-1}$) and standard errors of the mean of 20 simulation replicas for each system, for each component. The reference concentrations (**RC**) are the target initial concentrations of the system setup."
...
md"**Table S3** – Preferential solvation ($\Gamma_{\text{cp}}$) and preferential hydration ($\Gamma_{\text{wp}}$), and standard error of the mean of 20 simulation replicas, for all systems simulated. **RC** is the reference concentration of each system."
